...
// Requires geometry kernels F(...) and eqn9(...) provided by nano_geo_matrix/quasi_static/geometry/single.hpp or nano_geo_matrix/quasi_static/geometry/nanoshell.hpp.
#ifndef CUP_HAS_FROHLICH_GEOMETRY
  #error "Include nano_geo_matrix/quasi_static/geometry/single.hpp or nano_geo_matrix/quasi_static/geometry/nanoshell.hpp before cup.hpp (needed for F(...) and eqn9(...))."
#endif
